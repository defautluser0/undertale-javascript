import { draw_sprite_ext, getBoundingBox, instance_find, make_colour_hsv } from "/imports/assets/gamemakerFunctions.js";
...
function create() {
  ...
  const self = {
    ...
    image_angle: 0,
    image_blend: c_white,
    sprite_index: "spr_talkbt", // sprite object
...
function step() {
  ...
  if (this.spec === 1) {
    this.spec_x += 1;
    this.image_blend = make_colour_hsv(this.spec_x * 12, 160, 255);
  }
}

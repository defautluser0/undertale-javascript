...
function create() {
  ...
  const self = {
    ...
    sprite_width: 105, // set to sprite_index's width
    sprite_height: 108, // set to sprite_index's height
    image_angle: 0,
    image_blend: c_white,
    sprite_index: "spr_blconsm", // sprite object

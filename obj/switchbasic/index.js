import { draw_sprite_ext, getBoundingBox, script_execute } from "/imports/assets/gamemakerFunctions.js";
...
//                                                               // to this fake object
import * as parent from "/obj/interactable/index.js"; // change as neccesary. if no parent, replace this line with "const parent = null;"
...
function step() {
  if (this.myinteract === 1 && this.on === 1) {
    this.on = 0;
    this.myinteract = 0;
    this.image_index = 0;
  }

  if (this.myinteract === 1 && this.on === 0) {
    this.on = 1;
    this.myinteract = 0;
    this.image_index = 1;
  }

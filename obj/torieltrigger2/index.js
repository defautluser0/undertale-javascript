...
function step() {
  if (
    this.conversation === 0 &&
    (instance_find(obj_mainchara, 0).x > 140 ||
      instance_find(obj_mainchara, 0).y < 170)
  ) {
    global.msc = 204;
    global.typer = 4;
    global.interact = 1;
  ...
  if (instance_exists(obj_toroverworld4)) {
    if (
      this.conversation === 2 &&
      instance_find(obj_toroverworld4, 0).path_position === 1
    ) {
      this.conversation = 2.5;
      ...
      if (global.plot < 4) {
        global.plot = 4;
        instance_create(
          instance_find(obj_toroverworld4, 0).x,
          instance_find(obj_toroverworld4, 0).y,
  ...
  if (this.conversation === 2.5 && global.plot === 4.5) {
    ...
    if (instance_exists(obj_torinteractable1)) {
      instance_create(
        instance_find(obj_torinteractable1, 0).x,
        instance_find(obj_torinteractable1, 0).y,
        obj_toroverworld4
      );
  ...
  if (
    this.conversation === 4 &&
    global.plot === 5 &&
    !instance_exists(obj_shaker)
  ) {
    this.conversation = 3;

    if (instance_exists(obj_torinteractable2)) {
      instance_create(
        instance_find(obj_torinteractable2, 0).x,
        instance_find(obj_torinteractable2, 0).y,
        obj_toroverworld4
      );

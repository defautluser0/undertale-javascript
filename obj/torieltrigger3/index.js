import { draw_sprite_ext, getBoundingBox, _with, instance_create, instance_find, instance_exists, instance_destroy, path_start } from "/imports/assets/gamemakerFunctions.js";
import { c_white, path_torielwalk4, path_torielwalk4_2 } from "/imports/assets.js";
import global from "/imports/assets/global.js";

import * as obj_toroverworld4 from "/obj/toroverworld4/index.js";
import * as obj_torinteractable4 from "/obj/torinteractable4/index.js";
...
function create() {
  ...
  const self = {
    name: "torieltrigger3", // sprite name
...
function alarm7() {
  this.tor3 = instance_create(instance_find(obj_torinteractable4, 0).x, instance_find(obj_torinteractable4, 0).y, obj_toroverworld4);

  _with (obj_torinteractable4, function() {
    instance_destroy(this);
  })

  _with (this.tor3, function() {
    this.direction = 270;
  })
...
function step() {
  if (this.conversation === 1 && instance_exists(obj_toroverworld4)) {
    this.tor.facing = 0;
    global.msc = 211;
    global.typer = 4;
    global.facechoice = 1;
  ...
  if (this.conversation === 1.5 && !instance_exists(obj_dialoguer)) {
    _with(this.tor, function() {
      path_start.call(this, path_torielwalk4, 4, "path_action_stop", false)
    })
    global.interact = 0;
    this.conversation = 2;
  }

  if (this.conversation === 2 && instance_exists(obj_toroverworld4)) {
    if (instance_find(obj_toroverworld4, 0).path_position === 1) {
      this.tor2 = instance_create(this.tor.x, this.tor.y, obj_torinteractable4);

      _with (this.tor2, function() {
        this.direction = 270;
      })
  ...
  if (global.plot === 6 && this.conversation === 3) {
  ...
  if (this.conversation === 6 && !instance_exists(obj_dialoguer)) {
    _with (this.tor3, function() {
      path_start.call(this, path_torielwalk4_2, 3, "path_action_stop", false);
    })
...
function roomStart() {
  if (global.plot === 5 && this.conversation === 0) {
    this.tor = instance_create(60, 100, obj_toroverworld4);
    this.conversation = 1;
    global.interact = 1;
  }
}

export { create, updateAlarms, updateGamemakerFunctions, updateSprite, followPath, updateCol, parent, createContext, alarm7, step, roomStart };

...
function create() {
  ...
  const self = {
    ...
    stretchfactor:
      global.monsterinstance[global.mytarget].wd /
      global.monstermaxhp[global.mytarget],
  ...
  if (this.thisnum > 0) {
    if (this.drawbar === 1) {
      ...
      ossafe_fill_rectangle(
        ...
        this.ystart + 7,
        this.x +
          round(global.monstermaxhp[global.mytarget] * this.stretchfactor + 1),
        this.ystart + 21
      );
      ...
      ossafe_fill_rectangle(
        ...
        this.ystart + 8,
        this.x +
          round(global.monstermaxhp[global.mytarget] * this.stretchfactor),
        this.ystart + 20
      );
      ...
      if (this.apparenthp > 0) {
        ossafe_fill_rectangle(
          this.x,
          this.ystart + 8,
          round(this.x + this.apparenthp * this.stretchfactor),
          this.ystart + 20
        );
      }
    }
    ...
    for (let i = this.place; i >= 0; i -= 1) {
      ...
      if (this.stretchwidth <= 120)
        ...
        draw_sprite_ext(
          "spr_dmgnum_o",
          this.numnum[i],
          this.x - 30 + this.stretchwidth / 2 - i * 32 + this.place * 16,
          this.y - 28,
          1,
          1,
          0,
  ...
  if (this.thisnum === 0) {
    ...
    if (this.special === 1) {
      ...
      draw_text(
        this.x - 10,
        this.y - 10,
        scr_gettext("damage_special_" + string(this.ex))
      );
    }
  }

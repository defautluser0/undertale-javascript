import { draw_sprite_ext, instance_exists, draw_set_color, draw_rectangle, draw_sprite, instances, draw_text, string } from "/imports/assets/gamemakerFunctions.js";
import { c_white, c_black, c_red, c_yellow, fnt_curs } from "/imports/assets.js";
...
function create() {
  ...
  if (window.location.href === "https://undertale.defautluser0.xyz/room/fastbattle/") {
    global.border = 1;
  }
...
export { create, updateAlarms, updateGamemakerFunctions, updateSprite, parent, draw };

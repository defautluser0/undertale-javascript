import { draw_sprite_ext, getBoundingBox, script_execute, instance_create, instance_exists } from "/imports/assets/gamemakerFunctions.js";
import { scr_depth, snd_play } from "/imports/customFunctions.js"
import { c_white, snd_screenshake } from "/imports/assets.js";
...
function step() {
  if (this.myinteract === 1 && global.plot <= 4.5) {
    this.on = 1;
    this.myinteract = 0;
    this.image_index = 1;
    global.plot = 5;

...
function draw() {
	...
	if (global.interact == 5)
	{
			...
			if (global.menuno < 6)
					this.currentspot = global.menucoord[global.menuno];
			
			this.xx = view_xview[view_current];
			this.yy = view_yview[view_current] + 10;
			this.moveyy = this.yy;
			
			if (this.obj_mainchara.y > (this.yy + 120))
					this.moveyy += 135;
			
			if (global.menuno != 4)
			{
					draw_set_color(c_white);
					ossafe_fill_rectangle(16 + this.xx, 16 + this.moveyy, 86 + this.xx, 70 + this.moveyy);
					ossafe_fill_rectangle(16 + this.xx, 74 + this.yy, 86 + this.xx, 147 + this.yy);
					
					if (global.menuno == 1 || global.menuno == 5 || global.menuno == 6)
							ossafe_fill_rectangle(94 + this.xx, 16 + this.yy, 266 + this.xx, 196 + this.yy);
					...
					if (global.menuno == 2)
					{
							...
							ossafe_fill_rectangle(94 + this.xx, 16 + this.yy, xend + this.xx, 224 + this.yy);
					}
					
					if (global.menuno == 3)
							ossafe_fill_rectangle(94 + this.xx, 16 + this.yy, 266 + this.xx, 150 + this.yy);
					
					if (global.menuno == 7)
							ossafe_fill_rectangle(94 + this.xx, 16 + this.yy, 266 + this.xx, 216 + this.yy);
					
					draw_set_color(c_black);
					ossafe_fill_rectangle(19 + this.xx, 19 + this.moveyy, 83 + this.xx, 67 + this.moveyy);
					ossafe_fill_rectangle(19 + this.xx, 77 + this.yy, 83 + this.xx, 144 + this.yy);
					
					if (global.menuno == 1 || global.menuno == 5 || global.menuno == 6)
							ossafe_fill_rectangle(97 + this.xx, 19 + this.yy, 263 + this.xx, 193 + this.yy);
					...
					if (global.menuno == 2)
					{
							...
							ossafe_fill_rectangle(97 + this.xx, 19 + this.yy, xend + this.xx, 221 + this.yy);
					}
					
					if (global.menuno == 3)
							ossafe_fill_rectangle(97 + this.xx, 19 + this.yy, 263 + this.xx, 147 + this.yy);
					
					if (global.menuno == 7)
							ossafe_fill_rectangle(97 + this.xx, 19 + this.yy, 263 + this.xx, 213 + this.yy);
			...
			if (global.menuno == 2)
			{
					...
					if (global.lv == 1)
							this.nextlevel = 10 - global.xp;
					
					if (global.lv == 2)
							this.nextlevel = 30 - global.xp;
					
					if (global.lv == 3)
							this.nextlevel = 70 - global.xp;
					
					if (global.lv == 4)
							this.nextlevel = 120 - global.xp;
					
					if (global.lv == 5)
							this.nextlevel = 200 - global.xp;
					
					if (global.lv == 6)
							this.nextlevel = 300 - global.xp;
					
					if (global.lv == 7)
							this.nextlevel = 500 - global.xp;
					
					if (global.lv == 8)
							this.nextlevel = 800 - global.xp;
					
					if (global.lv == 9)
							this.nextlevel = 1200 - global.xp;
					
					if (global.lv == 10)
							this.nextlevel = 1700 - global.xp;
					
					if (global.lv == 11)
							this.nextlevel = 2500 - global.xp;
					
					if (global.lv == 12)
							this.nextlevel = 3500 - global.xp;
					
					if (global.lv == 13)
							this.nextlevel = 5000 - global.xp;
					
					if (global.lv == 14)
							this.nextlevel = 7000 - global.xp;
					
					if (global.lv == 15)
							this.nextlevel = 10000 - global.xp;
					
					if (global.lv == 16)
							this.nextlevel = 15000 - global.xp;
					
					if (global.lv == 17)
							this.nextlevel = 25000 - global.xp;
					
					if (global.lv == 18)
							this.nextlevel = 50000 - global.xp;
					
					if (global.lv == 19)
							this.nextlevel = 99999 - global.xp;
			...
			if (global.menuno == 4)
			{
					...
					scr_setfont(fnt_maintext, 0);
					draw_set_color(c_white);
					ossafe_fill_rectangle(54 + this.xx, 49 + this.yy, 265 + this.xx, 135 + this.yy);
					draw_set_color(c_black);
					ossafe_fill_rectangle(57 + this.xx, 52 + this.yy, 262 + this.xx, 132 + this.yy);
					draw_set_color(c_white);
					...
					if (global.language == "ja")
							...
							draw_text(namepos, 80 + this.yy, roomname);
			...
			if (global.menuno == 0)
			{
					...
					draw_sprite("spr_heartsmall", 0, 28 + this.xx, heart_y + this.yy + (18 * global.menucoord[0]));
			}
			...
			if (global.menuno == 1)
			{
					...
					draw_sprite("spr_heartsmall", 0, 104 + this.xx, heart_y + this.yy + (16 * global.menucoord[1]));
			}
			...
			if (global.menuno == 3)
			{
					...
					draw_sprite("spr_heartsmall", 0, 104 + this.xx, heart_y + this.yy + (16 * global.menucoord[3]));
			}
			...
			if (global.menuno == 6)
			{
					...
					draw_sprite("spr_heartsmall", 0, 104 + this.xx, heart_y + this.yy + (16 * global.menucoord[6]));
			}
			...
			if (global.menuno == 7)
			{
					...
					draw_sprite("spr_heartsmall", 0, 104 + this.xx, heart_y + this.yy + (16 * global.menucoord[7]));
			}
			...
			if (global.menuno == 5)
			{
					...
					if (global.menucoord[5] == 0)
							draw_sprite("spr_heartsmall", 0, 104 + this.xx + (45 * global.menucoord[5]), heart_y + this.yy);
					
					if (global.menucoord[5] == 1)
							draw_sprite("spr_heartsmall", 0, 104 + this.xx + ((45 * global.menucoord[5]) + 3), heart_y + this.yy);
					
					if (global.menucoord[5] == 2)
							draw_sprite("spr_heartsmall", 0, 104 + this.xx + ((45 * global.menucoord[5]) + 15), heart_y + this.yy);
			}

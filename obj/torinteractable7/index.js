import { draw_sprite_ext, instance_create, instance_destroy, instance_exists, script_execute } from "/imports/assets/gamemakerFunctions.js";
...
function alarm0() {
	...
	if (global.flag[7] == 1)
	{
		...
		if (global.flag[511] == 3)
		{
			...
			global.msg[8] = " * \"Travellers who climb&  Mt. Ebott are said&  to disappear.\"/"
			global.msg[9] = " \\E7* .../"
			global.msg[10] = " * Frisk./"
		...
		{
			global.msg[0] = " \\E2* Frisk..^1.&* You really ARE different&  from \\[C]./"
		...
		if (global.flag[511] == 6)
		{
			...
			global.msg[1] = " * Frisk^1, when \\[C]&  and I combined our&  SOULs together.../"

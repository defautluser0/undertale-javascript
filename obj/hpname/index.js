import { draw_sprite_ext, getBoundingBox, instance_exists, instance_find } from "/imports/assets/gamemakerFunctions.js";
...
function create() {
  ...
  const self = {
    name: "hpname", // sprite name
    depth: -99, // object depth
    ...
    image_angle: 0,
    image_blend: c_white,
    sprite_index: "spr_hpname", // sprite object
...
function step() {
  if (instance_exists(obj_battlecontroller)) {
    this.depth = instance_find(obj_battlecontroller, 0).depth;
  }
}

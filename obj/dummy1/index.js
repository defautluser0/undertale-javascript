import { draw_sprite_ext, getBoundingBox, instance_create, instance_find, instance_exists, instance_destroy, script_execute } from "/imports/assets/gamemakerFunctions.js";
...
import * as parent from "/obj/solidnpcparent/index.js"; // change as neccesary. if no parent, replace this line with "const parent = null;"
...
function create() {
  ...
  const self = {
    ...
    image_angle: 0,
    image_blend: c_white,
    sprite_index: "spr_dummy", // sprite object
...
function step() {
  if (this.myinteract === 1 && global.plot < 6) {
    global.flag[10] = 0;
    global.flag[11] = 0;
    global.flag[12] = 0;
    global.flag[13] = 0;
    ...
    instance_find(obj_mainchara, 0).depth =  -600;
...
export { create, updateAlarms, updateGamemakerFunctions, updateSprite, followPath, updateCol, parent, createContext, destroy, step, roomStart };

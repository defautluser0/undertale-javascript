...
function create() {
  ...
  const self = {
    name: "readable_switch1", // sprite name
...
function alarm0() {
  ...
  if (global.plot < 5) {
    if (instance_exists(obj_torinteractable2)) {
      instance_find(obj_torinteractable2, 0).lsprite = "spr_toriel_lt";
      global.msc = 0;
      global.typer = 4;
      global.facechoice = 1;
      global.faceemotion = 1;
      global.msg[0] = scr_gettext("obj_readable_switch1_65");
      global.msg[0] = scr_gettext("obj_readable_switch1_66");
      global.msg[0] = scr_gettext("obj_readable_switch1_67");

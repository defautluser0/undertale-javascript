...
function create() {
  ...
  return {
    name: "fader", // sprite name
    depth: -99999, // object depth
    image_xscale: roomSize.width * 3, // sprite scale
    image_yscale: roomSize.height * 2, // sprite scale
...
export { create, updateAlarms, updateGamemakerFunctions, updateSprite, parent, roomStart, beginStep };

...
function createContext() {
  if (
    window.location.href === "https://undertale.defautluser0.xyz/room/ruins3/"
  ) {
    this.yarl = 4.5;
  }
}
...
function step() {
  ...
  if (
    window.location.href ===
      "https://undertale.defautluser0.xyz/room/ruins9/" &&
    global.flag[35] === 1
  ) {
    this.image_index = 1;
  }
  ...
  if (
    window.location.href ===
      "https://undertale.defautluser0.xyz/room/ruins11/" &&
    global.flag[33] === 1
  ) {
    this.image_index = 1;
  }

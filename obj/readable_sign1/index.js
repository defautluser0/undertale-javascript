...
function create() {
  ...
  const self = {
    name: "readable_sign1", // sprite name
    ...
    image_angle: 0,
    image_blend: c_white,
    sprite_index: "spr_npc_sign", // sprite object
    visible: true, // sprite visibility
    friction: 0,
    gravity: 0,
    gravity_direction: 270, // gravity direction
    parent: parent,
    create2: true, // for createContext() to be called (true) or roomStart() to be called (false) on creation. should always be true unless legacy object

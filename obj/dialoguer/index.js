  ...
  if (global.facechange === 1) {
    if (instance_exists(OBJ_WRITER)) {
      ...
      switch (global.facechoice) {
        case 1:
          if (
            !instance_exists(obj_face_torieltalk) &&
            !instance_exists(obj_face_torielblink)
          ) {
...
function draw() {
  if (this.side === 0) {
    ...
    draw_rectangle(
      view_xview[view_current] + 16,
      view_yview[view_current] + 5,
      view_xview[view_current] + 304,
      view_yview[view_current] + 80,
      false
    );
    draw_set_color(c_black);
    draw_rectangle(
      view_xview[view_current] + 19,
      view_yview[view_current] + 8,
      view_xview[view_current] + 301,
      view_yview[view_current] + 77,
      false
    );
  } else {
    this.yy = view_yview[view_current];
    ...
    draw_rectangle(
      view_xview[view_current] + 16,
      view_yview[view_current] + 160,
      view_xview[view_current] + 304,
      view_yview[view_current] + 235,
      false
    );
    draw_set_color(c_black);
    draw_rectangle(
      view_xview[view_current] + 19,
      view_yview[view_current] + 163,
      view_xview[view_current] + 301,
      view_yview[view_current] + 232,
      false
    );
  }
  this.count = 1;

...
function create() {
  ...
  const self = {
    name: "toroverworld3", // sprite name
...
function step() {
  if (this.phone !== 2) {
    ...
    if (this.phone === 1) {
      this.sprite_index = "spr_toriel_d_phone";
    }
  }

  if (this.sprite_index === "spr_toriel_hug" && this.image_index >= 2) {
    this.image_speed = 0;
    this.sprite_index = "spr_toriel_hug2";
    this.dsprite = "spr_toriel_hug2";
  }
}

function animationEnd() {
  if (this.sprite_index === "spr_toriel_hug3") {

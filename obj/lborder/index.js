import { draw_sprite_ext, round, abs, instances, getBoundingBox } from "/imports/assets/gamemakerFunctions.js";
...
function endStep() {
  ...
  if (this.y != global.idealborder[3])
  {
    ...
    else
    {
        ...
        if (uborder.y > global.idealborder[2] && dborder.y > global.idealborder[3])
            this.y -= 15;
  ...
  if (this.x == global.idealborder[0] || global.idealborder[2] > (this.y + (this.image_yscale * 5)))
  {
